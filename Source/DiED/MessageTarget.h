...
namespace DiED
{
	...
	public:
		...
		virtual void vConnectionLost(const DiED::clientid_t & ClientID, const Network::address_t & ClientAddress, const Network::port_t & ClientPort) = 0;
		virtual void vPing(const DiED::messageid_t & PingID) = 0;
		virtual void vPong(const DiED::messageid_t & PingID) = 0;
	};
}
